...
export default function Footer() {
  return (
    <footer className="bg-[#121415] text-neutral-5 px-10 py-8 text-xs">
      <div className="mx-auto max-w-7xl">
        <div className="flex items-start justify-between mb-10">
          <div className="flex items-center gap-2 text-lg font-bold text-neutral-2">
            ...
            alt="입지너구리 로고"
            className="object-contain w-auto h-8 bg-white rounded-full "
          />
            <span>입지너구리</span>
          </div>

          <div className="text-right">
            <p className="mb-1 text-white">고객센터</p>
            <p className="mb-2 text-2xl font-bold text-white">1588-0000</p>
